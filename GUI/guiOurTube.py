...
class MainApplication:
    def __init__(self,master):
        ...
        img = PhotoImage(file=r'C:\Books\Coding\OurTube\GUI\icon.png')
        ...
        self.topframe=ttk.Frame(self.master,relief=GROOVE,height=110,width=580)
        ...
        self.download_btn=ttk.Button(self.master,text="Download",command=self.checkYoutubeLink)
